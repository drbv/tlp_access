        ...
        Do Until re.EOF
            ...
            Select Case get_bs_erg(re!Startkl, 3)
                ...
                Case "F_R", "F_F"   ' alle R'n'R Formationen
                    ...
                    line = Replace(line, "x__th1", make_a_inpRRE("ch1", 10, "Tanz - Choreografie, Musikinterpretation & tänzerische Darbietung"))
                    line = Replace(line, "x__sd1", make_a_inpRRE("tf1", 10, "Tanz - Tanzfiguren"))
                ...
                Case "BWBS_"
                    ...
                    Select Case left(re!Startkl, 6)
                        Case "BS_RR_"
                            If re!Startkl = "BS_RR_E" Or re!Startkl = "BS_RR_J2" Then
                                line = get_line("BS", "BW_RR_lang", ppr)
                            Else
                                line = get_line("BS", "BW_RR_kurz", ppr)
                            End If
                            
                        Case "BS_BW_", "BS_F_B", "BS_F_R"
