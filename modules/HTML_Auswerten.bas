...
Function Punkteverteilung(Startklasse, rd, rde)
    ...
    Select Case Startklasse
        Case "F_RR_ST"  ' Showteam
            punkte_verteilung = Array(15, 35, 5, 0, 7.5, 7.5, 30)
        Case "F_RR_GF"  ' Girl RR
            punkte_verteilung = Array(30, 30, 5, 0, 10, 10, 15)
        Case "F_RR_LF"  ' Lady RR
            punkte_verteilung = Array(30, 30, 5, 0, 10, 10, 15)
        Case "F_RR_J"   ' Jugend
            punkte_verteilung = Array(30, 30, 10, 0, 10, 10, 10)
        ...
        Case "RR_A", "RR_B"
            Select Case rd
                Case "VR"
                    punkte_verteilung = Array(6.25, 6.25, 6.25, 6.25, 7.5, 7.5, 10)
                Case "ZR"
                    punkte_verteilung = Array(7.25, 7.25, 7.25, 7.25, 8.7, 8.7, 11.6)
                Case "ER"
                    punkte_verteilung = Array(4.375, 4.375, 4.375, 4.375, 5.25, 5.25, 7)
            End Select
            If rde = "Semi" Then punkte_verteilung = Array(7.25, 7.25, 7.25, 7.25, 8.7, 8.7, 11.6)
        Case "RR_C"
            punkte_verteilung = Array(6, 6, 6, 6, 7.2, 7.2, 9.6)
        Case "RR_J"
...
'                            Punkte = Punkte / t * 4
'                        Case "ER"
'                            Punkte = Punkte / 6 * 8     '+ get_ft(vars.Item("WR_ID"), PR_ID, ft_rt)
'                        Case Else
'                            ' ist Fußtechnikrunde
'                    End Select
'
...
'                            Punkte = Punkte / t * 4
'                        Case "ER"
'                            Punkte = Punkte / IIf(t < 6, 5, 6) * 8  '+ get_ft(vars.Item("WR_ID"), PR_ID, ft_rt)
'                        Case Else
'                            ' ist Fußtechnikrunde
'                    End Select
'
