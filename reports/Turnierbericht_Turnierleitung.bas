...
Begin Report
    ...
    RecordSource ="SELECT DISTINCTROW Turnierleitung.Turniernr, Turnierleiter_Funktion.TLF_Reihenfo"
        ...
        " INNER JOIN Turnierleitung ON Turnierleiter_Funktion.TLF_ID = Turnierleitung.Art"
        " WHERE (((Turnierleitung.Turniernr)=[Formulare]![A-Programmübersicht]![akt_Turni"
        "er])) ORDER BY Turnierleiter_Funktion.TLF_Reihenfolge, Turnierleitung.TL_Nachnam"
        "e, Turnierleitung.TL_Vorname;"
    Caption ="Wertungsrichter"
    DatasheetFontName ="Arial"
    PrtMip = Begin
        0x65030000f5000000f5000000f5000000000000005c1800003b01000001000000 ,
